    ...
    return (
        <AS.SignInContainer>
            ...
            <AS.StyledForm onSubmit={handleSubmit(onChangeFormLib)}>
                <LoginInputForm variant='text' label='이메일' placeholder={INPUT_EMAIL_MESSAGE}
                                register={emailRegister} error={errors.email as FieldError}/>
                <LoginInputForm variant='password' label='비밀번호' placeholder={PASSWORD_FORM_MESSAGE}
                                register={passwordRegister} error={errors.password as FieldError}/>
                <LoginInputForm variant='password' label='비밀번호 확인' placeholder='비밀번호와 일치하는 값을 입력해 주세요.'
                                register={passwordCheckRegister} error={errors.passwordCheck as FieldError}/>
